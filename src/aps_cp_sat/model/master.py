...
def solve_master_model(
    ...
    if orders_df is not None:
        ...
        # ---- Profile guard: single-route hard enforcement ----
        expected_profile = "constructive_lns_virtual_guarded_frontload"
        ...
        # =====================================================================
        # Single main route: constructive_lns
        # =====================================================================
        ...
        if _should_escalate_evidence_failure(current_cfg.model.profile_name, evidence_level):
            print("[APS][feasibility_evidence] 褰撳墠鏁版嵁鍦ㄧ幇鏈夌‖璇箟涓嬪瓨鍦ㄥ己涓嶅彲琛屼俊鍙凤紝涓嶅缓璁户缁繁灞?fallback 鎼滅储")
